...
def main():
    ...
    QubitBloch.qscatter(qubit_sphere, ax, labelq='qubits on Bloch\'s sphere')
...
# 
    ...
    QubitBloch.qscatter(qsphere_transformed, ax_t, colorq='r', markerq='^', \
        labelq='transformed qubits on Bloch\'s sphere')
